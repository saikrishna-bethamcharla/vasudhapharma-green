...
(function () {
  ...
  const VAULT_DOCS = [
    ...
    },
    {
      ...
      categoryLabel: 'Environmental & EHS',
      authority: 'Bureau Veritas Certification',
      desc: 'Occupational health and safety management system guaranteeing safe cleanrooms, emergency response systems, and HAZOP reviews.',
      fileType: 'PDF',
      fileSize: '1.1 MB',
      status: 'Active (Valid to 2026)',
      url: 'assets/Vasudha_Sustainability_Report_2024-25.pdf#page=1'
    ...
    },
    {
      ...
      desc: 'Overview of commercial API portfolios, cryogenic reaction parameters, fluid-bed pelletization technologies, and global regulatory presence.',
      fileType: 'PDF',
      fileSize: '3.6 MB',
