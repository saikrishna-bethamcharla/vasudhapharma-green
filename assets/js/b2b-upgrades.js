...
(function () {
  ...
  window.vpDownloadProductPdf = function () {
    ...
    var printContent = [
      ...
      '  .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #EC3237; padding-bottom: 20px; margin-bottom: 30px; }',
      '  .brand h1 { margin: 0; font-size: 22px; color: #EC3237; text-transform: uppercase; letter-spacing: 0.5px; }',
