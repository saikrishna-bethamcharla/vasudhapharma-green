...
(function () {
  ...
  const VP_SITE_PAGES = [
    ...
    },
    {
      ...
      desc: "World-class manufacturing infrastructure across multi-purpose cGMP facilities",
      ...
      <div class="vp-header">
        ...
        <div class="vp-header-actions">
          <button type="button" class="vp-btn-icon vp-header-btn" id="vpBtnSound" title="Toggle audio chime" aria-label="Toggle chime">
            <svg id="vpIconSoundOn" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2">
              <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
              <path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path>
            </svg>
            <svg id="vpIconSoundOff" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" style="display:none !important;">
              <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
  ...
  function bindEvents() {
    ...
    if (soundBtn) {
      soundBtn.addEventListener('click', (e) => {
        ...
        const sOn = document.getElementById('vpIconSoundOn');
        const sOff = document.getElementById('vpIconSoundOff');
        if (sOn) sOn.style.setProperty('display', STATE.soundEnabled ? 'inline-block' : 'none', 'important');
        if (sOff) sOff.style.setProperty('display', STATE.soundEnabled ? 'none' : 'inline-block', 'important');
      });
    }
  ...
  function appendMessageToDOM(sender, htmlContent, scroll = true) {
    ...
    const copyBtnHtml = (sender === 'bot' && !htmlContent.includes('vp-rfq-card')) 
      ? `<div class="vp-msg-actions"><button type="button" class="vp-copy-msg-btn" title="Copy response text" onclick="copyBotMsg(this)"><svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg></button></div>` 
      : '';
